...
class Changelogs:
    ...
    def ChangeLogsDefine(self) -> None:
        ...
        self.changelogs = [
            ["+", "【新增】(Patch 1 .p1) 「新增歌曲」按鈕介面增加上版所新增的「列出最愛」列表功能", "=========="],
            ["+", "【新增】群組最愛功能來啦！", "=> 發現多一個按鈕了嗎？沒錯啦，你現在如果聽到一首喜歡的歌，您可以將其加入到最愛名單內！\n=> 你可以在 **/play** 選單中檢視你新增到最愛名單的內容，也可以一次播放名單內的所有歌曲！"],
            ["!", "【修復】(Patch 1 .p1) 修復「新增歌曲」按鈕無法使用的問題", "=========="],
            ["!", "【修復】(Patch 1 .p1) 修復歌曲資訊在跳過歌曲時的顯示問題", "=========="],
            ["!", "【修復】(Patch 1 .p1) 修改部分提示的文字", "=========="],
            ["!", "【修復】(Patch 1 .p1) 修復「加入最愛」按鈕有時不會正常顯示的問題", "=========="],
